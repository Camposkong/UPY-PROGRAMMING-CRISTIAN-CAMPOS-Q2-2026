import random
import stddraw
from color import Color # Corrección aquí para evitar errores de mayúsculas
...
# --- ANIMATED BUBBLE SORT (Tu código original) ---
...
# Aquí puedes comentar y descomentar el algoritmo que quieras probar
